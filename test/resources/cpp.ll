...
%class.C = type <{ i16, i16, i8, i8 }>
%union.U = type { i32, [4 x i8] }

; Function Attrs: noinline norecurse nounwind optnone ssp uwtable
define i32 @main() #0 {
  %1 = alloca i32, align 4
  %2 = alloca %class.C, align 2
  %3 = alloca %union.U, align 4
  store i32 0, i32* %1, align 4
  %4 = bitcast %union.U* %3 to i32*
  store i32 10, i32* %4, align 4
  %5 = bitcast %union.U* %3 to %class.C*
  %6 = bitcast %class.C* %5 to i8*
  %7 = bitcast %class.C* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 2 %7, i64 5, i1 false)
  ret i32 0
}
