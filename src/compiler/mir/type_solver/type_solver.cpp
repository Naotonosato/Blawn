...
void TypeSolver::add_type_variable(
    std::shared_ptr<TypeVariable> type_variable) {
    type_variables.add_root(type_variable);
}

void TypeSolver::bind(std::shared_ptr<TypeVariable> type_variable,
...
void TypeSolver::fetch_type(std::shared_ptr<TypeVariable> type_variable,
                            std::shared_ptr<TypeVariable> to_fetch) {
    auto root = type_variables.get_root(type_variable);
    *root = std::move(*to_fetch);
}

std::shared_ptr<TypeVariable> TypeSolver::solve(
