...
namespace graph
{
    namespace algorithm
    {
        template<typename VertexType> using Edge = std::pair<VertexType,VertexType>;
        ...
        */
        ...
        template<typename VertexType>
        void _depth_first_search(Edges<VertexType>& edges,VertexType start,VertexType goal,std::vector<Edge<VertexType>> stack)
        {        
        ...
        template<typename VertexType>
        void depth_first_search(Graph<VertexType> graph,VertexType start,VertexType goal)
        {
