...
std::shared_ptr<VariableNode> AssignmentNode::get_target_var() const {
    return target_var;
}

std::shared_ptr<AccessNode> AssignmentNode::get_target_member() const {
    return target_member;
}

std::shared_ptr<Node> AssignmentNode::get_right_node() const {
    return right_node;
}
