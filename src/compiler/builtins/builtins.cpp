...
void builtins::load_builtin_functions(llvm::LLVMContext& context,
    ...
    auto i64_to_i8_type =
        llvm::FunctionType::get(ir_builder.getInt8Ty(), i64_to_i8_args, false);
    auto i64_to_i32_type = llvm::FunctionType::get(ir_builder.getInt32Ty(),
                                                   i64_to_i32_args, false);
    auto i32_to_i8_type =
        llvm::FunctionType::get(ir_builder.getInt8Ty(), i32_to_i8_args, false);
    auto i8_to_i32_type =
        llvm::FunctionType::get(ir_builder.getInt32Ty(), i8_to_i32_args, false);
    auto i32_to_i64_type = llvm::FunctionType::get(ir_builder.getInt64Ty(),
                                                   i32_to_i64_args, false);
    auto i8_to_i64_type =
        llvm::FunctionType::get(ir_builder.getInt64Ty(), i8_to_i64_args, false);
    auto i64_to_i8 = llvm::Function::Create(
        i64_to_i8_type, llvm::Function::ExternalLinkage, "i64_to_i8", &module);
    auto i64_to_i32 =
        llvm::Function::Create(i64_to_i32_type, llvm::Function::ExternalLinkage,
                               "i64_to_i32", &module);
    auto i32_to_i8 = llvm::Function::Create(
        i32_to_i8_type, llvm::Function::ExternalLinkage, "i32_to_i8", &module);
    auto i8_to_i32 = llvm::Function::Create(
        i8_to_i32_type, llvm::Function::ExternalLinkage, "i8_to_i32", &module);
    auto i32_to_i64 =
        llvm::Function::Create(i32_to_i64_type, llvm::Function::ExternalLinkage,
                               "i32_to_i64", &module);
    auto i8_to_i64 = llvm::Function::Create(
        i8_to_i64_type, llvm::Function::ExternalLinkage, "i8_to_i64", &module);
    auto i64_to_i8_block =
        llvm::BasicBlock::Create(context, "i64_to_i8", i64_to_i8);
    ir_builder.SetInsertPoint(i64_to_i8_block);
    ir_builder.CreateRet(ir_builder.CreateIntCast(
        i64_to_i8->arg_begin(), ir_builder.getInt8Ty(), false));
    auto i64_to_i32_block =
        llvm::BasicBlock::Create(context, "i64_to_i32", i64_to_i32);
    ir_builder.SetInsertPoint(i64_to_i32_block);
    ir_builder.CreateRet(ir_builder.CreateIntCast(
        i64_to_i32->arg_begin(), ir_builder.getInt32Ty(), false));
    auto i32_to_i8_block =
        llvm::BasicBlock::Create(context, "i32_to_i8", i32_to_i8);
    ir_builder.SetInsertPoint(i32_to_i8_block);
    ir_builder.CreateRet(ir_builder.CreateIntCast(
        i32_to_i8->arg_begin(), ir_builder.getInt8Ty(), false));
    auto i8_to_i32_block =
        llvm::BasicBlock::Create(context, "i8_to_i32", i8_to_i32);
    ir_builder.SetInsertPoint(i8_to_i32_block);
    ir_builder.CreateRet(ir_builder.CreateIntCast(
        i8_to_i32->arg_begin(), ir_builder.getInt32Ty(), false));
    auto i32_to_i64_block =
        llvm::BasicBlock::Create(context, "i32_to_i64", i32_to_i64);
    ir_builder.SetInsertPoint(i32_to_i64_block);
    ir_builder.CreateRet(ir_builder.CreateIntCast(
        i32_to_i64->arg_begin(), ir_builder.getInt64Ty(), false));
    auto i8_to_i64_block =
        llvm::BasicBlock::Create(context, "i8_to_i64", i8_to_i64);
    ir_builder.SetInsertPoint(i8_to_i64_block);
    ir_builder.CreateRet(ir_builder.CreateIntCast(
        i8_to_i64->arg_begin(), ir_builder.getInt64Ty(), false));
...
void builtins::create_string_type(llvm::LLVMContext& context,
    ...
    auto to_char_ptr_type = llvm::FunctionType::get(ir_builder.getInt8PtrTy(),
                                                    to_char_ptr_args, false);
    auto to_char_ptr = llvm::Function::Create(to_char_ptr_type,
                                              llvm::Function::ExternalLinkage,
                                              "to_char_ptr", &module);
