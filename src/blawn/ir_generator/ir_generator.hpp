...
public:
  ...
  IRGenerator(llvm::LLVMContext& context, llvm::Module& module, llvm::IRBuilder<>& ir_builder);
...
class StoreIRGenerator : public IRGenerator {
  static void walk(llvm::Type* type, std::vector<std::pair<llvm::Value*, llvm::Value*>>& res,
...
public:
  BinaryExpressionIRGenerator(llvm::LLVMContext& context, llvm::Module& module,
                              llvm::IRBuilder<>& ir_builder)
      : IRGenerator(context, module, ir_builder) {}
  llvm::Value* generate(Node& node) override;
};
...
public:
  IfIRGenerator(llvm::LLVMContext& context, llvm::Module& module, llvm::IRBuilder<>& ir_builder)
      : IRGenerator(context, module, ir_builder) {}
  llvm::Value* generate(Node& node) override;
};
