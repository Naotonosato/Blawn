...
public:
  ...
  Node(int line_number, Scope self_scope, IRGenerator& ir_generator, std::string name = "",
      ...
      : _is_argument(is_argument),
        ...
        name(name) {}
  virtual llvm::ConstantInt* get_id() {
    return nullptr;
  }
  ...
  virtual bool is_typeid() {
    return false;
  }
  virtual bool is_function() {
    return false;
  }
  virtual bool is_calling_constructor() {
    return false;
  }
  virtual bool is_accessing() {
    return false;
  }
  virtual bool is_heap_user() {
    return false;
  }
  virtual int get_heap_id() {
    return -1;
  }
  virtual std::shared_ptr<Node> get_typeid_value() {
    return nullptr;
  }
...
public:
  ...
  void set_id(llvm::ConstantInt* id) {
    id_ = id;
  }
  llvm::ConstantInt* get_id() {
    return id_;
  }
  bool is_typeid() override {
    return true;
  }
  std::shared_ptr<Node> get_typeid_value() override {
    return value;
  }
};
...
public:
  ...
  std::shared_ptr<Node> get_idnode() {
    return id;
  }
  std::shared_ptr<Node> get_value() {
    return value;
...
public:
  ...
  VariableNode(int line_number, Scope self_scope, VariableIRGenerator& ir_generator,
               bool is_global, std::shared_ptr<Node> right_node, std::string name = "")
  ...
  bool is_heap_user() override {
    return _is_heap_user;
  }
  int get_heap_id() override {
    return _heap_id;
  }
...
public:
  ...
  std::shared_ptr<Node> get_left_node() {
    return left_node;
  }
  std::string get_right_name() {
    return right_name;
  }
  void set_pointer(llvm::Value* p) {
    pointer = p;
  }
  std::string get_left_typename();
  llvm::Value* get_pointer() {
    return pointer;
  }
  void set_call_node(std::shared_ptr<CallFunctionNode> n) {
    call_node = n;
  }
  std::shared_ptr<CallFunctionNode> get_call_node() {
    return call_node;
  }
  void set_generated(llvm::Value* c) {
    generated = c;
  }
  bool is_accessing() override {
    return true;
  }
  llvm::Value* get_generated() {
    return generated;
  }
};
...
public:
  ...
  AssigmentNode(int line_number, Scope self_scope, AssigmentIRGenerator& ir_generator,
                std::shared_ptr<Node> right_node,
                std::shared_ptr<VariableNode> target_var = nullptr, std::string name = "")
      : Node(line_number, self_scope, ir_generator, name),
        right_node(right_node),
  ...
  AssigmentNode(int line_number, Scope self_scope, AssigmentIRGenerator& ir_generator,
                std::shared_ptr<Node> right_node,
                std::shared_ptr<AccessNode> target_member = nullptr, std::string name = "")
      : Node(line_number, self_scope, ir_generator, name),
        right_node(right_node),
        target_var(nullptr),
        target_member(target_member) {}
  AssigmentNode(int line_number, Scope self_scope, AssigmentIRGenerator& ir_generator,
                std::shared_ptr<Node> right_node, std::shared_ptr<ArgumentNode> target_arg,
                std::string name = "")
      : Node(line_number, self_scope, ir_generator, name),
        right_node(right_node),
        target_var(nullptr),
...
public:
  DeclareCNode(int line_number, Scope self_scope, DeclareCIRGenerator& ir_generator,
               std::string name, std::vector<std::shared_ptr<Node>> arguments_type,
...
public:
  ...
  CallFunctionNode(int line_number, Scope self_scope, CallFunctionIRGenerator& ir_generator,
                   std::vector<std::shared_ptr<Node>> passed_arguments,
                   NodeCollector<ArgumentNode>& argument_collector, std::string name)
      : Node(line_number, self_scope, ir_generator, name),
...
public:
  ClassNode(int line_number, Scope self_scope, ClassIRGenerator& ir_generator,
            std::vector<std::shared_ptr<FunctionNode>> methods,
            std::vector<std::shared_ptr<Node>> members_definition,
            std::vector<std::string> arguments_names, bool is_C_type, std::string name = "")
      : Node(line_number, self_scope, ir_generator, name),
        methods(methods),
        members_definition(members_definition),
        arguments_names(arguments_names),
        _is_C_type(is_C_type) {}
  std::vector<std::string> get_arguments_names() {
    return arguments_names;
  }
  std::vector<std::shared_ptr<Node>> get_members_definition() {
    return members_definition;
  };
  std::vector<std::shared_ptr<FunctionNode>> get_methods() {
    return methods;
  }
  ...
  void set_self_namespace(Scope n) {
    self_namespace = n;
  }
  Scope get_self_namespace() {
...
public:
  ...
  CallConstructorNode(int line_number, Scope self_scope,
                      ...
                      std::shared_ptr<ClassNode> class_node,
                      std::vector<std::shared_ptr<Node>> passed_arguments, Scope belong_to,
                      NodeCollector<ArgumentNode>& argument_collector, std::string name = "")
      : Node(line_number, self_scope, ir_generator, name),
        class_node(class_node),
        passed_arguments(passed_arguments),
        ...
        argument_collector(argument_collector),
        _heap_id(-1) {}
  std::shared_ptr<ClassNode> get_class() {
    return class_node;
  }
  ...
  bool is_calling_constructor() override {
    return true;
  }
  bool is_heap_user() override {
    return true;
...
public:
  IfNode(int line_number, Scope self_scope, IfIRGenerator& ir_generator,
         std::shared_ptr<Node> conditions, std::vector<std::shared_ptr<Node>> if_body,
         std::vector<std::shared_ptr<Node>> else_body)
      : Node(line_number, self_scope, ir_generator),
        conditions(conditions),
        if_body(if_body),
        else_body(else_body) {}
  std::shared_ptr<Node> get_conditions() {
    return conditions;
  }
  std::vector<std::shared_ptr<Node>> get_if_body() {
    return if_body;
  }
  std::vector<std::shared_ptr<Node>> get_else_body() {
    return else_body;
  }
...
public:
  ForNode(int line_number, Scope self_scope, ForIRGenerator& ir_generator,
          std::shared_ptr<Node> left_expression, std::shared_ptr<Node> center_expression,
          std::shared_ptr<Node> right_expression, std::vector<std::shared_ptr<Node>> body)
      : Node(line_number, self_scope, ir_generator),
        left_expression(right_expression),
        center_expression(center_expression),
        right_expression(right_expression),
        body(body) {}
  std::shared_ptr<Node> get_left_expression() {
    return left_expression;
  }
  std::shared_ptr<Node> get_center_expression() {
    return center_expression;
  }
  std::shared_ptr<Node> get_right_expression() {
    return right_expression;
  }
  std::vector<std::shared_ptr<Node>>& get_body() {
    return body;
  }
};
