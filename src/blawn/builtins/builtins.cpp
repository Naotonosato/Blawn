...
void builtins::load_builtin_functions(llvm::LLVMContext& context, llvm::Module& module,
  ...
  auto i64_to_i8_type = llvm::FunctionType::get(ir_builder.getInt8Ty(), i64_to_i8_args, false);
  auto i64_to_i32_type =
      llvm::FunctionType::get(ir_builder.getInt32Ty(), i64_to_i32_args, false);
  auto i32_to_i8_type = llvm::FunctionType::get(ir_builder.getInt8Ty(), i32_to_i8_args, false);
  auto i8_to_i32_type = llvm::FunctionType::get(ir_builder.getInt32Ty(), i8_to_i32_args, false);
  auto i32_to_i64_type =
      llvm::FunctionType::get(ir_builder.getInt64Ty(), i32_to_i64_args, false);
  auto i8_to_i64_type = llvm::FunctionType::get(ir_builder.getInt64Ty(), i8_to_i64_args, false);
  auto i64_to_i8      = llvm::Function::Create(i64_to_i8_type, llvm::Function::ExternalLinkage,
                                          "i64_to_i8", &module);
  auto i64_to_i32     = llvm::Function::Create(i64_to_i32_type, llvm::Function::ExternalLinkage,
                                           "i64_to_i32", &module);
  auto i32_to_i8      = llvm::Function::Create(i32_to_i8_type, llvm::Function::ExternalLinkage,
                                          "i32_to_i8", &module);
  auto i8_to_i32      = llvm::Function::Create(i8_to_i32_type, llvm::Function::ExternalLinkage,
                                          "i8_to_i32", &module);
  auto i32_to_i64     = llvm::Function::Create(i32_to_i64_type, llvm::Function::ExternalLinkage,
                                           "i32_to_i64", &module);
  auto i8_to_i64      = llvm::Function::Create(i8_to_i64_type, llvm::Function::ExternalLinkage,
                                          "i8_to_i64", &module);
  ...
  blawn_memcpy_args.push_back(ir_builder.getInt64Ty());
  blawn_memcpy_args.push_back(ir_builder.getInt8PtrTy());
  auto blawn_memcpy_type =
      llvm::FunctionType::get(ir_builder.getVoidTy(), blawn_memcpy_args, false);
  auto blawn_memcpy = llvm::Function::Create(blawn_memcpy_type, llvm::Function::ExternalLinkage,
                                             "blawn_memcpy", &module);
  ...
  blawn_realloc_args.push_back(ir_builder.getInt64Ty());
  auto blawn_realloc_type =
      llvm::FunctionType::get(ir_builder.getInt8PtrTy(), blawn_realloc_args, false);
  auto blawn_realloc = llvm::Function::Create(
      blawn_realloc_type, llvm::Function::ExternalLinkage, "blawn_realloc", &module);
  ...
  blawn_index_args.push_back(ir_builder.getInt64Ty());
  blawn_index_args.push_back(ir_builder.getInt64Ty());
  auto blawn_index_type =
      llvm::FunctionType::get(ir_builder.getInt8PtrTy(), blawn_index_args, false);
  auto blawn_index = llvm::Function::Create(blawn_index_type, llvm::Function::ExternalLinkage,
                                            "blawn_index", &module);
  ...
  blawn_set_element_args.push_back(ir_builder.getInt8PtrTy());
  blawn_set_element_args.push_back(ir_builder.getInt64Ty());
  auto blawn_set_element_type =
      llvm::FunctionType::get(ir_builder.getInt8PtrTy(), blawn_set_element_args, false);
  auto blawn_set_element = llvm::Function::Create(
      blawn_set_element_type, llvm::Function::ExternalLinkage, "blawn_set_element", &module);
  get_blawn_context().add_builtin_function("__blawn_set_element__", blawn_set_element);
}

void builtins::create_string_type(llvm::LLVMContext& context, llvm::Module& module,
                                  llvm::IRBuilder<>& ir_builder) {
  ...
  auto constructor_type =
      llvm::FunctionType::get(string_type->getPointerTo(), constructor_args, false);
  ...
  append_method_args.push_back(string_type->getPointerTo());
  auto append_method_type =
      llvm::FunctionType::get(ir_builder.getVoidTy(), append_method_args, false);
  auto append_method = llvm::Function::Create(
      append_method_type, llvm::Function::ExternalLinkage, "append_string", &module);
  ...
  auto print =
      llvm::Function::Create(print_type, llvm::Function::ExternalLinkage, "print", &module);
  get_blawn_context().add_builtin_function("print", print);

  std::vector<llvm::Type*> to_char_ptr_args(1, string_type->getPointerTo());
  auto to_char_ptr_type =
      llvm::FunctionType::get(ir_builder.getInt8PtrTy(), to_char_ptr_args, false);
  auto to_char_ptr = llvm::Function::Create(to_char_ptr_type, llvm::Function::ExternalLinkage,
                                            "to_char_ptr", &module);
  ...
  auto int_to_str_type =
      llvm::FunctionType::get(string_type->getPointerTo(), int_to_str_args, false);
  auto int_to_str = llvm::Function::Create(int_to_str_type, llvm::Function::ExternalLinkage,
                                           "int_to_str", &module);
  ...
  auto float_to_str_type =
      llvm::FunctionType::get(string_type->getPointerTo(), float_to_str_args, false);
  auto float_to_str = llvm::Function::Create(float_to_str_type, llvm::Function::ExternalLinkage,
                                             "float_to_str", &module);
