...
void split(std::string text, std::string splitter, std::vector<std::string>& res);
...
llvm::Value* malloc_value(llvm::Type* type, llvm::LLVMContext& context, llvm::Module& module,
                          llvm::IRBuilder<>& ir_builder);
llvm::Value* free_value(llvm::Value* to_delete_ptr, llvm::Module& module,
                        llvm::IRBuilder<>& ir_builder);
llvm::Type* get_or_create_type(llvm::LLVMContext&, std::shared_ptr<ClassNode>, std::string);
} // namespace utils