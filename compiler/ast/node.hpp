...
public:  
    ...
    std::string name;
    Node(int line_number,IRGenerator& ir_generator,std::string name="",bool is_argument=false)
    :_is_argument(is_argument),line_number(line_number),
    ir_generator(ir_generator),name(name){}
...
class AccessNode:public Node
{
    ...
    public:
    AccessNode(int line_number,
        AccessIRGenerator& ir_generator,
        std::shared_ptr<Node> left_node,
        std::string right_name,
        NodeCollector<FunctionNode>& function_collector
        ):Node(line_number,ir_generator),left_node(left_node),left_value(nullptr),
...
class AssigmentNode:public Node
{
    ...
    :Node(line_number,ir_generator,name),right_node(right_node),
...
public:
    ...
    BinaryExpressionNode(int line_number,BinaryExpressionIRGenerator& ir_generator)
    :Node(line_number,ir_generator){}
};
...
public:
    ...
    FunctionNode(int line_number,
        FunctionIRGenerator& ir_generator,
        std::string name,std::vector<std::string> arguments_names,
        std::vector<std::shared_ptr<Node>> body,
        std::shared_ptr<Node> return_value
        )
    :Node(line_number,ir_generator,name),arguments_names(arguments_names),
...
class IfNode: public Node
{
    ...
    public:
    IfNode(int line_number,
        IfIRGenerator& ir_generator,
        std::shared_ptr<Node> conditions,
        std::vector<std::shared_ptr<Node>> if_body,
        std::vector<std::shared_ptr<Node>> else_body
        )
    :Node(line_number,ir_generator),conditions(conditions),
...
class ForNode: public Node
{
    ...
    :Node(line_number,ir_generator),left_expression(right_expression),
